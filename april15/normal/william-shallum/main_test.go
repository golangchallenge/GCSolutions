...
func readAndExpect(r io.Reader, buflen int, expected string, t *testing.T) {
...
func TestShortReads(t *testing.T) {
	...
	go (func() {
		io.WriteString(secureW, "hello ")
		io.WriteString(secureW, "world\n")
	})()

	// make sure reading a few bytes at a time works
	readAndExpect(secureR, 3, "hel", t)
	readAndExpect(secureR, 2, "lo", t)
	// reads past end of message are short (XXX impl detail)
	readAndExpect(secureR, 3, " ", t)

	readAndExpect(secureR, 3, "wor", t)
	readAndExpect(secureR, 3, "ld\n", t)
}
